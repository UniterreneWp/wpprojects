...
var sm = {dashboard_model:'', dashboard_key: '',dashboard_select_options: '',sm_nonce: '',search_query: [], search_count:0},
    page = 1,
    hideDialog = '',
    inline_edit_dlg = '',
...
var load_dashboard = function () {
    ...
    col_model_search = Object.keys(col_model).map(function(k) { return col_model[k] });
    ...
    jQuery(document).trigger("sm_load_dashboard_complete"); //event for adding custom code on load dashboard
