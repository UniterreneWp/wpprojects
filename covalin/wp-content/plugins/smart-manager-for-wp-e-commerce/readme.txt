...
= 3.10.0 =
New feature of advanced search functionality for all dashboards(btea), billing address & customer id columns in orders csv export (woocommerce) along with other important fixes & updates. Recommended upgrade.
