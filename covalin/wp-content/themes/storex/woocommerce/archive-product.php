		...
		<?php if ( have_posts() ) : ?>
			...
			if ( get_option('filters_sidebar')=='on' && is_active_sidebar( 'filters-sidebar' ) ) : ?>
				<div id="filters-sidebar" class="widget-area">
					<span class="filter-head"><?php esc_html_e( 'Filters:', 'storex'); ?></span>
					<?php dynamic_sidebar('filters-sidebar'); ?>
				</div>
			<?php endif; */?>

			<?php woocommerce_product_loop_start(); 
//echo '<ul class="products grid-layout" data-isotope="container" data-isotope-layout="fitrows" data-isotope-elements="product">';
			?>
