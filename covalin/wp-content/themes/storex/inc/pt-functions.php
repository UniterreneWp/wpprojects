...
/* Contents:
	...
	5.  Storex Adding inline CSS styles
	6.  Theme url functions
	7.  Storex get attached images
	8.  Storex comment function
	9. Storex pagination for gallery
	10. Add Max excerpt function for Mega Post
	11. Add Meta Box for PT Mega Post
 */
...
/* 5 Storex Adding inline CSS styles (start)*/
...
if ( !function_exists( 'storex_add_inline_styles' ) && get_option('site_custom_colors') == 'on' ) {
	...
	function storex_add_inline_styles() {
		...
		$footer_font_color_link = esc_attr(get_option('footer_link_color_hover'));
		...
		$out = '<style type="text/css">
				...
				.widget_shopping_cart:hover .cart-icon:before{
					box-shadow: inset 0 0 0 1px '.$button_color.';
				}
				...
				.single-product.woocommerce .summary.entry-summary .compare:after, .single-product.woocommerce-page .summary.entry-summary .compare:after{
					box-shadow: inset 0 0 0 20px '.$button_color.';
				}
...
/* 5 Storex Adding inline CSS styles (end)*/

/* 6 Theme url functions (start)*/
...
/* 6 Theme url functions (end)*/

/* 7 Storex get attached images (start)*/
...
/* 7 Storex get attached images (end)*/

/* 8 Storex comment function (start)*/
...
/* 8 Storex comment function (end)*/

/* 9 Storex pagination for gallery (start)*/
...
/* 9 Storex pagination for gallery (end)*/

/* 10 Add Max excerpt function for Mega Post(start)*/
...
/* 10 Add Max excerpt function for Mega Post(end)*/

/* 11. Add Meta Box for PT Mega Post (start)*/
